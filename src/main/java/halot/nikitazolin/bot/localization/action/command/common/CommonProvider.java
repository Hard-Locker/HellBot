package halot.nikitazolin.bot.localization.action.command.common;
...
@Component
@Slf4j
public class CommonProvider implements LanguageProvider {

  private static final String VOCABULARY_PATH = "localization.halot.nikitazolin.bot.discord.action.command.common.common";
