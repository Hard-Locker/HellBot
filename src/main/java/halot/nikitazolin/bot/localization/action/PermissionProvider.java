package halot.nikitazolin.bot.localization.action;
...
@Component
@Slf4j
public class PermissionProvider implements LanguageProvider {

  private static final String VOCABULARY_PATH = "localization.halot.nikitazolin.bot.discord.action.permission";
