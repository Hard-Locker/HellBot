package halot.nikitazolin.bot.localization.action.command.setting;
...
@Component
@Slf4j
public class SettingProvider implements LanguageProvider {

  private static final String VOCABULARY_PATH = "localization.halot.nikitazolin.bot.discord.action.command.setting.setting";
